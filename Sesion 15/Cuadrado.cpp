...
public:
   ...
   double Area(){	// A implementar
      return (longitud*longitud);
   }

   double Perimetro(){	// A implementar
      return (longitud*4);
   }
   ...
   Circunferencia CircunferenciaInscrita(){
   		Punto2D centro_cuadrado=Centro();
   		
    	Circunferencia inscrita(centro_cuadrado.Abscisa(),centro_cuadrado.Ordenada(), longitud/2);
   ...
   Circunferencia CircunferenciaCircunscrita(){
    	...
    	SegmentoDirigido distancia_centro_esquina(esquina_abscisa,esquina_ordenada,centro_cuadrado.Abscisa(),centro_cuadrado.Ordenada());
   		
    	Circunferencia inscrita(centro_cuadrado.Abscisa(),centro_cuadrado.Ordenada(), distancia_centro_esquina.Longitud());
   }
